...
ARG VITE_APPLE_WEB_SERVICE_ID
ARG VITE_APPLE_WEB_REDIRECT_URI
ENV VITE_GOOGLE_CLIENT_ID=$VITE_GOOGLE_CLIENT_ID
ENV VITE_API_URL=$VITE_API_URL
# What shared links say out loud. Unset falls back in lib/share.js.
ENV VITE_PUBLIC_ORIGIN=$VITE_PUBLIC_ORIGIN
ENV VITE_APPLE_WEB_SERVICE_ID=$VITE_APPLE_WEB_SERVICE_ID
ENV VITE_APPLE_WEB_REDIRECT_URI=$VITE_APPLE_WEB_REDIRECT_URI
