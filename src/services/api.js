...
export async function createPersonalPlan(googleId, { name, description = '', venue = '', date_start, date_end = null, note = '', invitee_google_ids = [], image_url = '', source_url = '', source_ig_handle = '', post = null }) {
  ...
  const res = await fetchWithTimeout(
    `${BASE_URL}/events/private`,
    {
      ...
      body: JSON.stringify({
        ...
        invitee_google_ids, image_url, source_url, source_ig_handle, post,
      }),
    },
    15000,
  )
